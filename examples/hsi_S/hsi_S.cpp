...
// 作成したスプライトはpushSpriteで任意の座標に出力できます。
//    base.pushSprite(-8,16,0); // (x,y)=((180-120)/2,(180-120)/2)  compassに出力する。透過色あり
    base.pushSprite(24,24,0); // (x,y)=((180-120)/2,(180-120)/2)  compassに出力する。透過色あり
...
// base airplane
/*
  base.drawFastVLine( 64, 10, 60, TFT_WHITE);
  base.drawFastHLine( 54, 40, 20, TFT_WHITE);
  base.fillTriangle(64,10,  64-3,10+5, 64+3,10+5, TFT_WHITE);// 45
*/
//120 -> 64
